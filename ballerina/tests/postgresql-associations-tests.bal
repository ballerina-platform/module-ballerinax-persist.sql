...
@test:Config {
    ...
    dependsOn: [postgresqlEmployeeDeleteTestNegative]
}
function postgresqlEmployeeRelationsTest() returns error? {
...
function postgresqlDepartmentRelationsTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["associations", "postgresql"],
    dependsOn: [postgresqlEmployeeRelationsTest]
}
function postgresqlWorkspaceRelationsTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlBuildingRelationsTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
