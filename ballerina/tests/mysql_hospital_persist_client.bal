...
public isolated client class MySqlHospitalClient {
    *persist:AbstractPersistClient;
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            [APPOINTMENT]: check new (dbClient, self.metadata.get(APPOINTMENT), MYSQL_SPECIFICS),
            [PATIENT]: check new (dbClient, self.metadata.get(PATIENT), MYSQL_SPECIFICS),
            [DOCTOR]: check new (dbClient, self.metadata.get(DOCTOR), MYSQL_SPECIFICS)
        };
    }
