...
@test:Config {
    groups: ["building", "postgresql"]
}
function postgresqlBuildingCreateTest() returns error? {
...
function postgresqlBuildingCreateTest2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlBuildingCreateTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql"],
    dependsOn: [postgresqlBuildingCreateTest]
}
function postgresqlBuildingReadOneTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlBuildingReadOneTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql"],
    dependsOn: [postgresqlBuildingCreateTest, postgresqlBuildingCreateTest2]
}
function postgresqlBuildingReadManyTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql", "dependent"],
    dependsOn: [postgresqlBuildingCreateTest, postgresqlBuildingCreateTest2]
}
function postgresqlBuildingReadManyDependentTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql"],
    dependsOn: [postgresqlBuildingReadOneTest, postgresqlBuildingReadManyTest, postgresqlBuildingReadManyDependentTest]
}
function postgresqlBuildingUpdateTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlBuildingUpdateTestNegative1() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlBuildingUpdateTestNegative2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql"],
    dependsOn: [postgresqlBuildingUpdateTest, postgresqlBuildingUpdateTestNegative2]
}
function postgresqlBuildingDeleteTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["building", "postgresql"],
    dependsOn: [postgresqlBuildingDeleteTest]
}
function postgresqlBuildingDeleteTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
