...
function testCreatePatientMsSqlWithSchema() returns error? {
...
function testCreateDoctorMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
    DoctorInsert doctor = {
      id: 1,
      name: "Doctor Mouse",
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreateDoctorMsSqlWithSchema]
}
function testCreateDoctorAlreadyExistsMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
    DoctorInsert doctor = {
      id: 1,
      name: "Doctor Mouse",
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreatePatientMsSqlWithSchema, testCreateDoctorMsSqlWithSchema]
}
function testCreateAppointmentMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreatePatientMsSqlWithSchema, testCreateDoctorMsSqlWithSchema, testCreateAppointmentMsSqlWithSchema]
}
function testCreateAppointmentAlreadyExistsMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
    AppointmentInsert appointment = {
      id: 1,
      patientId: 1,
...
function testGetDoctorsMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreatePatientMsSqlWithSchema]
}
function testGetPatientByIdMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreateAppointmentMsSqlWithSchema]
}
function testGetAppointmentByDoctorMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
function testGetAppointmentByPatientMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
    stream<AppointmentWithRelations, persist:Error?> appointments = mssqlDbHospital->/appointments();
    AppointmentWithRelations[]|persist:Error? filteredAppointments =  from AppointmentWithRelations appointment in appointments
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreateAppointmentMsSqlWithSchema, testGetAppointmentByDoctorMsSqlWithSchema, testGetAppointmentByPatientMsSqlWithSchema]
}
function testPatchAppointmentMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testCreateAppointmentMsSqlWithSchema, testGetAppointmentByDoctorMsSqlWithSchema, testGetAppointmentByPatientMsSqlWithSchema, testPatchAppointmentMsSqlWithSchema]
}
function testDeleteAppointmentByPatientIdMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testGetPatientByIdMsSqlWithSchema, testDeleteAppointmentByPatientIdMsSqlWithSchema]
}
function testDeletePatientMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
...
@test:Config{
  groups: ["annotation", "mssql", "schema"],
  dependsOn: [testGetDoctorsMsSqlWithSchema, testDeleteAppointmentByPatientIdMsSqlWithSchema],
  enable: true
}
function testDeleteDoctorMsSqlWithSchema() returns error? {
    MsSqlHospitalWithSchemaClient mssqlDbHospital = check new();
