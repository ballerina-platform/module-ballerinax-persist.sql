...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlBuildingDeleteTestNegative]
}
function postgresqlWorkspaceCreateTest() returns error? {
...
function postgresqlWorkspaceCreateTest2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlWorkspaceCreateTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceCreateTest]
}
function postgresqlWorkspaceReadOneTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlWorkspaceReadOneDependentTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlWorkspaceReadOneTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceCreateTest, postgresqlWorkspaceCreateTest2]
}
function postgresqlWorkspaceReadManyTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql", "dependent"],
    dependsOn: [postgresqlWorkspaceCreateTest, postgresqlWorkspaceCreateTest2]
}
function postgresqlWorkspaceReadManyDependentTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceReadOneTest, postgresqlWorkspaceReadManyTest, postgresqlWorkspaceReadManyDependentTest]
}
function postgresqlWorkspaceUpdateTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceReadOneTest, postgresqlWorkspaceReadManyTest, postgresqlWorkspaceReadManyDependentTest, postgresqlWorkspaceReadWithClauses]
}
function postgresqlWorkspaceUpdateTestNegative1() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlWorkspaceUpdateTestNegative2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceUpdateTest, postgresqlWorkspaceUpdateTestNegative2]
}
function postgresqlWorkspaceDeleteTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["workspace", "postgresql"],
    dependsOn: [postgresqlWorkspaceDeleteTest]
}
function postgresqlWorkspaceDeleteTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
