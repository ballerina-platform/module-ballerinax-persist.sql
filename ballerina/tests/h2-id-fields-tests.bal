...
function h2IntIdFieldTest() returns error? {
...
function h2StringIdFieldTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
...
function h2FloatIdFieldTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
...
function h2DecimalIdFieldTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
...
function h2BooleanIdFieldTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
...
function h2AllTypesIdFieldTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
    ...
    AllTypesIdRecord[] allTypesIdRecords = check from AllTypesIdRecord allTypesIdRecord in testEntitiesClient->/alltypesidrecords.get(AllTypesIdRecord)
        order by allTypesIdRecord.intType
...
@test:Config {
    groups: ["id-fields", "h2", "associations"],
    dependsOn: [h2AllTypesIdFieldTest]
}
function h2CompositeAssociationsTest() returns error? {
    H2TestEntitiesClient testEntitiesClient = check new ();
