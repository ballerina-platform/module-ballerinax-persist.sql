...
@test:Config {
    ...
    dependsOn: [postgresqlWorkspaceDeleteTestNegative, postgresqlDepartmentDeleteTestNegative]
}
function postgresqlEmployeeCreateTest() returns error? {
...
function postgresqlEmployeeCreateTest2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeCreateTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["employee", "postgresql"],
    dependsOn: [postgresqlEmployeeCreateTest]
}
function postgresqlEmployeeReadOneTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeReadOneTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["employee", "postgresql"],
    dependsOn: [postgresqlEmployeeCreateTest, postgresqlEmployeeCreateTest2]
}
function postgresqlEmployeeReadManyTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeReadManyDependentTest1() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeReadManyDependentTest2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["employee", "postgresql"],
    dependsOn: [postgresqlEmployeeReadOneTest, postgresqlEmployeeReadManyTest, postgresqlEmployeeReadManyDependentTest1, postgresqlEmployeeReadManyDependentTest2]
}
function postgresqlEmployeeUpdateTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeUpdateTestNegative1() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeUpdateTestNegative2() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
function postgresqlEmployeeUpdateTestNegative3() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["employee", "postgresql"],
    dependsOn: [postgresqlEmployeeUpdateTest, postgresqlEmployeeUpdateTestNegative2, postgresqlEmployeeUpdateTestNegative3]
}
function postgresqlEmployeeDeleteTest() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
...
@test:Config {
    groups: ["employee", "postgresql"],
    dependsOn: [postgresqlEmployeeDeleteTest]
}
function postgresqlEmployeeDeleteTestNegative() returns error? {
    PostgreSQLRainierClient rainierClient = check new ();
